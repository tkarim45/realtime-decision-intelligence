...
Split-conformal (LAC / Least Ambiguous set-valued
...
WHY THIS EARNS ITS PLACE HERE. There is a real confusion in this data: dependency_failure
...
one: an ambiguous set is precisely the signal to send the event to a log-reading review step
